...
| M1-04 | Outbox, idempotency, and stop flags | M1-02, M1-03 | READY_FOR_REVIEW | Transactional outbox plus lease prevents duplicates under 100 concurrent repeats; global/account stop blocks in-flight worker before external request; unknown outcome requires reconciliation. Local acceptance and hosted PR CI pass; reviewer acceptance remains. |

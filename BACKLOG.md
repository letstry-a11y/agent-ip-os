...
| M1-02 | Temporal parent/child workflow | M1-01, M0-05 | READY_FOR_REVIEW | Durable parent/independent children, one-human approval wait, PostgreSQL CAS Activities, atomic intent/outbox replay, terminal/retry paths, persistent Temporal restart, and a healthy six-service Mock-only stack are implemented. See [M1-02 evidence](docs/acceptance/m1-02-temporal-workflow.md). |

...
| M1-06 | Minimal approval API/page | M1-03, M1-04 | READY_FOR_REVIEW | Server-resolved Mock human identity, immutable evidence binding, one-human approve/reject/revision transaction, expiry/CAS/R4/self-bypass guards, responsive review desk, and browser/API/PostgreSQL evidence are recorded in [M1-06 evidence](docs/acceptance/m1-06-approval-console.md). |

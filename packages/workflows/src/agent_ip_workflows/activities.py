...
class PostgresWorkflowActivities:
    ...
    async def create_publish_intent_and_outbox(self, command: IntentCommand) -> None:
        """Atomically create the logical Mock intent/outbox pair and tolerate Activity retry."""
